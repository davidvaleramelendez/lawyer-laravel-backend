...
class CaseController extends Controller
{
    ...
    public function letter_add(Request $request) {
        try {
            ...
            if($request->frist_date=="") $request->frist_date=".";
            ...
            $letters_list = Letters::where('id', $userID)->first();
            $response = array();
            $response['flag'] = true;
            $response['message'] = 'Success.';
            $response['data'] = $letters_list;
            return response()->json($response);
        } catch (\Exception $e) {
            $response = array();
            $response['flag'] = false;
    ...
    public function letter_update(Request $request) {
        try {
            ...
            $letters_list = Letters::where(['case_id'=> $case_id,'deleted'=>0])->get();
            $response = array();
            $response['flag'] = true;
            $response['message'] = 'Success.';
            $response['data'] = $letters_list;
